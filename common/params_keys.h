...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"CurveSpeedProfile", {PERSISTENT, INT, "3", "3", 2}},
    ...
    {"DiscordUsername", {PERSISTENT | DONT_LOG, STRING, "", "", 0}},
    ...
    {"DrivingModel", {PERSISTENT, STRING, "dark-souls_default", "dark-souls_default", 1}},
    {"DrivingModelName", {PERSISTENT, STRING, "Dark Souls (Default) 👀📡", "Dark Souls (Default) 👀📡", 1}},
    ...
    {"FrogPilotRegistration", {PERSISTENT | DONT_LOG, STRING, "", "", 0}},
    {"FrogPilotStats", {PERSISTENT | DONT_LOG, JSON, "{}", "{}"}},
    {"FrogPilotTelemetry", {PERSISTENT, BOOL, "1", "1", 0}},
    ...
    {"KonikDongleId", {PERSISTENT | DONT_LOG, STRING, "", "", 0}},
    ...
    {"MapBoxRequests", {PERSISTENT | DONT_LOG, JSON, "{}", "{}"}},
    ...
    {"MaxDesiredAcceleration", {PERSISTENT, FLOAT, "4.0", "2.0", 3}},
    {"MaxLateralAcceleration", {PERSISTENT, JSON, "{}", "{}", 3}},
    ...
    {"ResetCurveData", {PERSISTENT, STRING, "", "", 1}},
    ...
    {"SpeedLimitFiller", {PERSISTENT, BOOL, "1", "0", 0}},
    {"SpeedLimitFillerShareData", {PERSISTENT, BOOL, "1", "0", 0}},
    {"SpeedLimits", {PERSISTENT | DONT_LOG, JSON, "[]", "[]"}},
    {"SpeedLimitsUploadedHash", {PERSISTENT | DONT_LOG, STRING, "", ""}},
    ...
    {"StockDongleId", {PERSISTENT | DONT_LOG, STRING, "", ""}},
    ...
    {"ToyotaDSUBypass", {PERSISTENT, BOOL, "0", "0", 2}},
