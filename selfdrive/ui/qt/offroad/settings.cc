...
void TogglesPanel::refreshMetric(bool metric) {
  uiState()->scene.is_metric = metric;
...
#ifdef ENABLE_MAPS
  toggles["NavSettingLeftSide"]->setVisible(!frogpilot_toggles.value("full_map").toBool());
#endif
