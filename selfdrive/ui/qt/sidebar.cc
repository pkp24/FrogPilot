...
void Sidebar::updateTheme() {
  ...
  loadImage("../../frogpilot/selfdrive/assets/active_theme/icons/button_settings", settings_img, settings_gif, settings_btn.size(), this);
...
void Sidebar::updateHomeButton() {
  ...
  if (onroad) {
    ...
    loadImage("../../frogpilot/selfdrive/assets/active_theme/icons/button_flag", flag_img, flag_gif, home_btn.size(), this);
  } else {
    clearMovie(flag_gif, this);
    if (util::random_int(0, 100) == 69 && frogpilot_toggles.value("random_events").toBool()) {
      loadImage("../../frogpilot/selfdrive/assets/random_events/icons/button_home", home_img, home_gif, home_btn.size(), this);
    } else {
      loadImage("../../frogpilot/selfdrive/assets/active_theme/icons/button_home", home_img, home_gif, home_btn.size(), this);
    }
  }
}
