...
from openpilot.frogpilot.classic_modeld.parse_model_outputs import Parser
from openpilot.frogpilot.classic_modeld.fill_model_msg import fill_model_msg, fill_pose_msg, PublishState
...
def main(demo=False):
  ...
  while True:
    ...
    steer_delay = sm["liveDelay"].lateralDelay + .2
